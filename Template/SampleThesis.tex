\documentclass{cseuoi-thesis} % Αν δεν βάλουμε τίποτα το default είναι Ελληνικά και PhD
%\documentclass[Greek,PhD]{cseuoi-thesis}
%\documentclass[English,Master]{cseuoi-thesis}
