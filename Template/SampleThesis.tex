...
% (γλώσσα, είδος διατριβής και, αν απαιτείται, εξειδίκευση)
%
\documentclass[en,phd]{cseuoi-thesis} % Διδακτορικό (στα Αγγλικά)
%\documentclass[gr,phd]{cseuoi-thesis} % Διδακτορικό (στα Ελληνικά)
%\documentclass[en,msc,systems]{cseuoi-thesis} % Μεταπτυχιακό με ειδίκευση στα Προηγμένα Υπολογιστικά Συστήματα (στα Αγγλικά)
%\documentclass[gr,msc,systems]{cseuoi-thesis} % Μεταπτυχιακό με ειδίκευση στα Προηγμένα Υπολογιστικά Συστήματα (στα Ελληνικά)
%\documentclass[gr,msc,data]{cseuoi-thesis} % Μεταπτυχιακό με ειδίκευση στην Επιστήμη και Μηχανική Δεδομένων (στα Ελληνικά)
%\documentclass[en,msc,data]{cseuoi-thesis} % Μεταπτυχιακό με ειδίκευση στην Επιστήμη και Μηχανική Δεδομένων (στα Αγγλικά)
...
% Προσοχή, μόνο το έτος γράφεται παρακάτω!
\dateGr{\colorbox{gray}{2021}}
\dateEn{\colorbox{gray}{2021}}
...
%\PHDadvisory{Vasilios Vasiliou}{Assist.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDadvisory{Georgios Georgiou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDadvisory{Dimitrios Dimitriou}{Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%% 7μελής εξεταστική επιτροπή
%\PHDexaminer{Antonios Antoniou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Vasilios Vasiliou}{Assist.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Georgios Georgiou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Dimitrios Dimitriou}{Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Ioannis Ioannou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Nikolaos Nikolaou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\PHDexaminer{Petros Petrou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
...
%\MSCexaminer{Antonios Antoniou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina (Advisor)}
%\MSCexaminer{Vasilios Vasiliou}{Assist.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
%\MSCexaminer{Georgios Georgiou}{Assoc.\ Professor}%
%    {Department of Computer Science and Engineering, University of Ioannina}
